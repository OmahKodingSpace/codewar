...
def call_claude(prompt: str) -> str:
    ...
    Prefers the OpenAI SDK when OPENAI_API_KEY is set; otherwise falls
    ...
    ``OPENAI_API_KEY`` to route through the SDK and skip the subprocess.
    """
    ...
    if api_key:
        try:
            ...
            return strip_llm_wrapper((msg.choices[0].message.content or "").strip())
        except ImportError:
            pass  # openai not installed, fall back to CLI
