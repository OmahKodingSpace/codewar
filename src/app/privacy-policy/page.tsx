    ...
    <div className='min-h-screen px-4 py-12 sm:px-6 lg:px-8'>
      <div className='mx-auto max-w-3xl space-y-8'>
        ...
        <section>
          ...
          <p className='text-muted-foreground text-base leading-relaxed'>
            Our application uses a custom authentication system with secure
            password hashing and JWT-based sessions. All passwords are hashed
            using bcrypt before storage and authentication tokens are stored as
